...
import { driverReviews } from '../data';
...
const DriverReviews = () => {
                ...
                <TouchableWithoutFeedback
                    ...
                    <View style={[styles.modalContainer]}>
                        <View style={[styles.modalSubContainer, {
                            ...
                            />
                            <TextInput
                                placeholder="This driver is so nice 🔥"
    ...
    */
    const renderContent = () => {
        ...
        const filteredReviews = selectedRating === "All" ? driverReviews : driverReviews.filter(review => review.avgRating === selectedRating);
        return (
            <ScrollView
