                ...
                <View style={Onboarding1Styles.contentContainer}>
                    ...
                    <View style={Onboarding1Styles.buttonContainer}>
                        <View style={Onboarding1Styles.titleContainer}>
                            <Text style={[Onboarding1Styles.title, { color: colors.text }]}>Book Your Perfect</Text>
                            <Text style={Onboarding1Styles.subTitle}>RIDE</Text>
                        </View>

                        <Text style={[Onboarding1Styles.description, { color: colors.text }]}>
                            We provide professional taxi services for your perfect journey.
                        </Text>
