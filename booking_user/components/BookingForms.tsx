    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <Input
          ...
          placeholder="Source"
          icon={icons.location}
          onInputChanged={(id, v) => setFields((f) => ({ ...f, source: v }))}
          value={fields.source}
        />
...
export const RoundTripForm = () => {
  ...
  const addDestination = () =>
    setFields((f) => ({ ...f, destinations: [...f.destinations, ""] }));
  const setDestination = (idx: number, val: string) =>
    setFields((f) => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <TouchableOpacity onPress={addDestination} style={styles.addBtn}>
